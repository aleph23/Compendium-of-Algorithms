...
export default defineConfig({
  ...
  integrations: [
    starlight({
      ...
      components: {
        Head: "./src/components/CompendiumHead.astro",
      },
      social: {
        github: "https://github.com/aleph23/compendium-of-algorithms",
      },
      sidebar: [
        {
          ...
          items: [
            ...
            { label: "Foundations",             autogenerate: { directory: "received-canon/foundations" } },
